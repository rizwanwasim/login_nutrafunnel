...
describe("Login Functionality of Nutrofunnel", () => {
    it("Login Functionality with valid credentials", () => {
        ...
        // cy.visit("https://staging.nutrafunnels.com/coaching-list/")
        // cy.url().should('include', '/coaching-list/')
        // cy.url().reload();
        // cy.visit("https://staging.nutrafunnels.com/");
    });
    // Add more test cases for invalid login attempts, edge cases, etc. as needed
